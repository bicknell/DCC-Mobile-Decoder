...
void function_control(void) {
    ...
    if (my_dcc_functions[1]) { do { LATAbits.LATA2 = 1; } while(0); } else { do { LATAbits.LATA2 = 0; } while(0); }
    if (my_dcc_functions[2]) { do { LATCbits.LATC3 = 1; } while(0); } else { do { LATCbits.LATC3 = 0; } while(0); }
    if (my_dcc_functions[3]) { do { LATCbits.LATC2 = 1; } while(0); } else { do { LATCbits.LATC2 = 0; } while(0); }
    if (my_dcc_functions[4]) { do { LATCbits.LATC6 = 1; } while(0); } else { do { LATCbits.LATC6 = 0; } while(0); }
    if (my_dcc_functions[5]) { do { LATAbits.LATA0 = 1; } while(0); } else { do { LATAbits.LATA0 = 0; } while(0); }
    if (my_dcc_functions[6]) { do { LATAbits.LATA1 = 1; } while(0); } else { do { LATAbits.LATA1 = 0; } while(0); }
